    ...
    <>
      ...
      <div className="hero-standard" style={{ position:'relative', width:'100%', height:320, overflow:'hidden', background:'rgb(38,38,38)' }}>
        ...
        <div style={{ position:'absolute', inset:0, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center' }}>
          <h1 className="servicio-hero-h1" style={{ fontFamily:'Montserrat, sans-serif', fontSize:56, fontWeight:200, letterSpacing:'8px', textTransform:'uppercase', color:'#fff', marginBottom:14, lineHeight:1.05 }}>CONTÁCTANOS</h1>
